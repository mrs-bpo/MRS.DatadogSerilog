...
namespace DatadogHelper
{
    ...
    public class DatadogDirectLogger
    {
        ...
        /// <param name="logFilePath">File path for backup logs</param>
        /// <returns>True if successful</returns>
        public static bool Initialize(string apiKey, string serviceName , string environment , string logFilePath )
        {
            try
            {
                if (_isInitialized)
        ...
        /// </summary>
        public static bool InitializeBasic(string logFilePath)
        {
            try
            {
